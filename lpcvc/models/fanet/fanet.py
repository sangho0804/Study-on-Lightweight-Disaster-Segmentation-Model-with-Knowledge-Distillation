...
from .resnet import Resnet18, Resnet101, Resnet152
...
class FANet(nn.Module):
    def __init__(self,
        ...
        if backbone == 'resnet18':
            ...
            self.expansion = 4
            self.resnet = Resnet101(norm_layer=norm_layer, pretrained=True)
        elif backbone == 'resnet152':
            self.expansion = 4
            self.resnet = Resnet152(norm_layer=norm_layer, pretrained=True)
        else:
